<form action="" method="POST">
    ...
    <div>
        ...
        <input type="datetime-local" name="start_time" value="{{ convertDateTimeLocal($model->start_time) }}" id="">
    </div>
    <div>
        <label for="">Thời gian kết thúc</label>
        <input type="datetime-local" name="end_time" value="{{ convertDateTimeLocal($model->end_time) }}" id="">
    </div>
    <div>
